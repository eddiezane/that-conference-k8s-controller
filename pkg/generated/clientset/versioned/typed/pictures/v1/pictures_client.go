...
import (
	...
	"github.com/eddiezane/that-conference-k8s-controller/pkg/generated/clientset/versioned/scheme"
...
func (c *KuberneddiesV1Client) Pictures(namespace string) PictureInterface {
	return newPictures(c, namespace)
}

// NewForConfig creates a new KuberneddiesV1Client for the given config.
...
// NewForConfigAndClient creates a new KuberneddiesV1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KuberneddiesV1Client, error) {
	...
	return &KuberneddiesV1Client{client}, nil
}

// NewForConfigOrDie creates a new KuberneddiesV1Client for the given config and
...
func New(c rest.Interface) *KuberneddiesV1Client {
	return &KuberneddiesV1Client{c}
}
